...
const MyProfile = () => {
  ...
  const [userData, setUserData] = useState({
    ...
    email : "aravindSwamy@gamil.com",
    phone : '+91 9087654321',
    address : {
      line1 : "east cross road",
  ...
  return (
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
      ...
      <div className=''>
        <p className='text-neut500 underline mt-3'>CONTACT INFORMATION</p>
        <div className=' grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
          ...
          <p className='font-medium'>Address:</p>
          {
            ...
            <p>
              ...
              <br />
              <input className='bg-gray100' onChange={(e)=>{setUserData(prev=>({...prev, address : {...prev.address, line2 : e.target.value}}))}} value={userData.address.line2} type="text" />
            </p>
            :
      ...
      <div>
        <p className='text-neut500 underline mt-3'>BASIC INFORMATION</p>
