      ...
      <div>
        {
          doctors.slice(0,5).map((item, index)=>(
              <div className='grid grid-cols-[1fr_2fr] gap-4 sm:flex sm:gap-6 py-2 border-b border-b-gray-300' key={index}>
                <div>
                  <img className='w-32 bg-teal-50' src={item.image} alt="" />
                </div>
                ...
                <div className='flex-1 text-sm text-zinc-600 '>
                  ...
                  <p className='text-sm mt-1'><span className='text-sm text-neutral-700 font-medium' >Date & Time:</span> {new Date().toLocaleString()}</p>
                </div>
